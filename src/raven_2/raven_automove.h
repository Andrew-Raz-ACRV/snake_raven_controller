...
struct raven_automove_ {
  ...
  typedef boost::array<float, 16>  _joint_pos_d_type;
  boost::array<float, 16>  joint_pos_d;
...
================================================================================\n\
MSG: joint_pos_d\n\
# This is the desired joint position as an array with size 16\n\
\n\
float32 joint_pos_d\n\
\n\
";
...
s << std::endl;
    ...
    //Print Joint desired value
    s << indent << "joint_pos_d[]" << std::endl;
    for (size_t i = 0; i < v.joint_pos_d.size(); ++i)
    {
      s << indent << "  joint_pos_d[" << i << "]: ";
      Printer<float>::stream(s, indent + "  ", v.joint_pos_d[i]);
    }
  }
};
