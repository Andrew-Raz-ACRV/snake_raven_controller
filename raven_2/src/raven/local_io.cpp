...
void publish_joints(robot_device *device0) {
  ...
  joint_state.position[0] = device0->mech[left].joint[0].jpos * r2d + 27; //+ TH1_J0_L * d2r + offsets_l.shoulder_off;
  joint_state.name[1] = "elbow_L";
  joint_state.position[1] = device0->mech[left].joint[1].jpos * r2d - 183; //+ TH2_J1_L * d2r + offsets_l.elbow_off;
  ...
  joint_state.position[7] = device0->mech[right].joint[0].jpos * r2d - 53; //+ TH1_J0_R * d2r + offsets_r.shoulder_off;
  joint_state.name[8] = "elbow_R";
  joint_state.position[8] = device0->mech[right].joint[1].jpos * r2d - 152; //+ TH2_J1_R * d2r + offsets_r.elbow_off;
